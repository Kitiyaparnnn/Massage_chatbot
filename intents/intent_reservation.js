...
exports.intentReservation = function intentReservation(stage) {
  ...
  var current_date = today_date.getFullYear().toString() +'-'+ (today_date.getMonth()+1).toString() + '-' + today_date.getDate().toString();
  ...
  var next3_date = max_date.getFullYear().toString() +'-'+ (max_date.getMonth()+1).toString() + '-' + max_date.getDate().toString();
